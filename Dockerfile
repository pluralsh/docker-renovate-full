...
ARG RENOVATE_VERSION=32.241.11
...
RUN install-tool node v14.21.1
...
RUN install-tool java 11.0.17+8
...
RUN install-pip pipenv 2022.11.11
...
RUN install-gem bundler 2.3.25
